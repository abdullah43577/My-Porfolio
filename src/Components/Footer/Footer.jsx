  ...
  return (
    <footer id="contact-me" className="relative">
      <div className="innerContainer mb-16 p-8">
        ...
        <form action="" className="flex w-full max-w-[800px] flex-col gap-[1.5rem] rounded-lg bg-white p-10 md:ml-auto md:grid" onClick={handleForm}>
      ...
      <a href="#home">
        <div className="scroll-to-top absolute bottom-16 right-8 flex h-16 w-16 translate-y-[-40%] items-center justify-center rounded-full bg-navBar md:translate-y-[0%]">
